...
flowchart TD
    ...
    style ClerkCheck fill:#fff3e0
    style SignIn fill:#ffebee
    style DashAccess fill:#e8f5e9
```
...
flowchart LR
    ...
    style Frontend fill:#e3f2fd,stroke:#01579b,stroke-width:2px
